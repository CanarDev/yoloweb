...
<div className="flex h-full w-full">      
  ...
  {/* content left */}
    <div className="flex flex-col w-[calc(100%)] h-full">
...
<div className="flex h-full w-full">      
  ...
  <div className="h-full flex flex-col w-[calc(100%)] relative cursor-pointer bg-dark-blue group/item transition ease-in-out delay-50 hover:bg-[#0b487d]">
