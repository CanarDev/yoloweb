...
export default function Reptilians() {
    ...
    return (
        <div className="w-full h-full bg-gradient-to-b from-dark-blue to-green-reptilian p-8 flex flex-col items-center justify-center reptiliansSection">
            ...
            <ImgComparisonSlider value="10" hover="hover" className="flex items-center overflow-hidden rounded-3xl reptilian-slider md:w-3/4">
