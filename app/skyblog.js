...
export default function Skyblog() {
    return (
        <main className="h-screen bg-[#6667AB] flex p-10">
            <div className="w-1/4 bg-[#0F4C81] m-2 flex flex-col">
            ...
            <div className="w-1/2 bg-[#0F4C81] m-2 flex flex-col text-[#F5DF4D]">
                <div className="flex flex-col m-2">
                    <div className="bg-[#6667AB] flex p-3">
                    ...
                    <div className="bg-[#91A8D0] flex justify-around">
